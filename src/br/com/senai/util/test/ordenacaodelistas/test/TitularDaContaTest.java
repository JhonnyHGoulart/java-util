...
import br.com.senai.banco.modelo.Cliente;
...
import br.com.senai.util.test.ordenacaodelistas.classes.TitularDaContaComparator;

import java.util.ArrayList;
import java.util.List;

public class TitularDaContaTest {
    public static void main(String[] args) {

        Conta cc1 = new ContaCorrente(22, 33);
        Cliente clienteCC1 = new Cliente();
        clienteCC1.setNome("Jhonny");
